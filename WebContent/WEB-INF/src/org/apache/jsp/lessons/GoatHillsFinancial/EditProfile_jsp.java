...
public final class EditProfile_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
	...
	Employee employee = (Employee) session.getAttribute("GoatHillsFinancial.Employee");
      ...
      out.print(GoatHillsFinancial.FIRST_NAME);
      out.write("\" type=\"text\" value=\"");
      out.print(employee.getFirstName());
      out.write("\"/>\r\n\t\t\t\t  </TD>\r\n\t\t\t\t\t<TD width=\"110\">\t\t\t\t\r\n\t\t\t\t\t\tLast Name:\t\t\t\t\t</TD>\r\n\t\t\t\t\t<TD width=\"196\">\r\n\t\t\t\t\t \t<input class=\"lesson_text_db\" name=\"");
      out.print(GoatHillsFinancial.LAST_NAME);
      out.write("\" type=\"text\" value=\"");
      out.print(employee.getLastName());
      out.write("\"/>\r\n\t\t\t\t  </TD>\r\n\t\t\t\t</TR>\r\n\t\t\t\t<TR><TD>\t\t\t\t\r\n\t\t\t\t\t\tStreet: \r\n\t\t\t\t\t</TD>\r\n\t\t\t\t\t<TD>\r\n\t\t\t\t\t\t<input class=\"lesson_text_db\" name=\"");
      out.print(GoatHillsFinancial.ADDRESS1);
      out.write("\" type=\"text\" value=\"");
      out.print(employee.getAddress1());
      out.write("\"/>\r\n\t\t\t\t\t</TD>\r\n\t\t\t\t\t<TD>\t\t\t\t\r\n\t\t\t\t\t\tCity/State: \r\n\t\t\t\t\t<TD>\r\n\t\t\t\t\t\t<input class=\"lesson_text_db\" name=\"");
      out.print(GoatHillsFinancial.ADDRESS2);
      out.write("\" type=\"text\" value=\"");
      out.print(employee.getAddress2());
      out.write("\"/>\r\n\t\t\t\t\t</TD>\r\n\t\t\t\t</TR>\r\n\t\t\t\t<TR><TD>\r\n\t\t\t\t\t\tPhone: \r\n\t\t\t\t\t</TD>\r\n\t\t\t\t\t<TD>\r\n\t\t\t\t\t\t<input class=\"lesson_text_db\" name=\"");
      out.print(GoatHillsFinancial.PHONE_NUMBER);
      out.write("\" type=\"text\" value=\"");
      out.print(employee.getPhoneNumber());
      out.write("\"/>\r\n\t\t\t\t\t</TD>\r\n\t\t\t\t\t<TD>\t\t\t\t\r\n\t\t\t\t\t\tStart Date: \r\n\t\t\t\t\t</TD>\r\n\t\t\t\t\t<TD>\r\n\t\t\t\t\t\t<input class=\"lesson_text_db\" name=\"");
      out.print(GoatHillsFinancial.START_DATE);
      out.write("\" type=\"text\" value=\"");
      out.print(employee.getStartDate());
      out.write("\"/>\r\n\t\t\t\t\t</TD>\r\n\t\t\t\t</TR>\r\n\t\t\t\t<TR><TD>\r\n\t\t\t    \t\tSSN: \r\n\t\t\t    \t</TD>\r\n\t\t\t    \t<TD>\r\n\t\t\t    \t\t<input class=\"lesson_text_db\" name=\"");
      out.print(GoatHillsFinancial.SSN);
      out.write("\" type=\"text\" value=\"");
      out.print(employee.getSsn());
      out.write("\"/> \r\n\t\t\t\t\t</TD>\r\n\t\t\t\t\t<TD>\t\t\t\t\r\n\t\t\t\t\t\tSalary: \r\n\t\t\t\t\t</TD>\r\n\t\t\t\t\t<TD>\r\n\t\t\t\t\t\t<input class=\"lesson_text_db\" name=\"");
      out.print(GoatHillsFinancial.SALARY);
      out.write("\" type=\"text\" value=\"");
      out.print(employee.getSalary());
      out.write("\"/>\r\n\t\t\t\t\t</TD>\r\n\t\t\t\t</TR>\r\n\t\t\t\t<TR><TD>\r\n\t\t\t\t\t\tCredit Card: \r\n\t\t\t\t\t</TD>\r\n\t\t\t\t\t<TD>\r\n\t\t\t\t\t\t<input class=\"lesson_text_db\" name=\"");
      out.print(GoatHillsFinancial.CCN);
      out.write("\" type=\"text\" value=\"");
      out.print(employee.getCcn());
      out.write("\"/>\r\n\t\t\t\t\t</TD>\r\n\t\t\t\t\t<TD>\t\t\t\t\r\n\t\t\t\t\t\tCredit Card Limit: \r\n\t\t\t\t\t</TD>\r\n\t\t\t\t\t<TD>\r\n\t\t\t\t\t\t<input class=\"lesson_text_db\" name=\"");
      out.print(GoatHillsFinancial.CCN_LIMIT);
      out.write("\" type=\"text\" value=\"");
      out.print(employee.getCcnLimit());
      out.write("\"/>\r\n\t\t\t\t\t</TD>\r\n\t\t\t\t</TR>\r\n\t\t\t\t<TR><TD>\r\n\t\t\t\t\t\tComments: \r\n\t\t\t\t\t</TD>\r\n\t\t\t\t\t<TD colspan=\"3\">\r\n\t\t\t\t\t\t<input name=\"");
      out.print(GoatHillsFinancial.DESCRIPTION);
      out.write("\" type=\"text\" class=\"lesson_text_db\" value=\"");
      out.print(employee.getPersonalDescription());
      out.write("\" size=\"58\"/>\r\n\t\t\t\t\t</TD>\r\n\t\t\t\t<TR>\r\n\t\t\t\t\t<TD colspan=\"2\">\t\t\t\t\r\n\t\t\t\t\t\tDisciplinary Explanation:  \r\n\t\t\t\t\t</TD>\r\n\t\t\t\t\t<TD>\t\t\t\r\n\t\t\t\t\t\tDisc. Date:\r\n\t\t\t\t\t</TD>\r\n\t\t\t\t\t<TD>\t\t\t\r\n\t\t\t\t\t\t<input class=\"lesson_text_db\" name=\"");
      out.print(GoatHillsFinancial.DISCIPLINARY_DATE);
      out.write("\" type=\"text\" value=\"");
      out.print(employee.getDisciplinaryActionDate());
      out.write("\"/>\r\n\t\t\t\t\t</TD>\r\n\t\t\t\t</TR>\r\n\t\t\t\t<TR>\r\n\t\t\t\t\t<TD colspan=\"4\">\r\n\t\t\t\t\t\t<textarea name=\"");
      out.print(GoatHillsFinancial.DISCIPLINARY_NOTES);
      out.write("\" cols=\"53\" rows=\"2\" class=\"lesson_text_db\" >");
      out.print(employee.getDisciplinaryActionNotes());
      out.write("</textarea>\r\n\t\t\t\t\t</TD>\r\n\t\t\t\t</TR>\r\n\t\t\t\t<TR>\t\r\n\t\t\t\t<TD>\t\t\t\t\r\n\t\t\t\t\t\tManager: \r\n\t\t\t\t\t</TD>\r\n\t\t\t\t\t<TD>\r\n\t\t\t\t\t\t<select class=\"lesson_text_db\" name=\"");
      out.print(GoatHillsFinancial.MANAGER);
      out.write("\">\r\n\t\t\t\t\t\t");
      ...
      out.write("\">\r\n\t\t\t\t\t\t\t<input name=\"");
      out.print(GoatHillsFinancial.TITLE);
      out.write("\" type=\"hidden\" value=\"");
      out.print(employee.getTitle());
      out.write("\">\r\n\t\t\t\t\t\t\t<input type=\"submit\" name=\"action\" value=\"");
      out.print(GoatHillsFinancial.UPDATEPROFILE_ACTION);
      out.write("\"/>\r\n\t\t\t\t\t\t</td>\r\n                        \t<td width=\"211\"></td>\r\n                        \t<td width=\"83\">\r\n\t \t\t\t\t\t\t<input type=\"submit\" name=\"action\" value=\"");
